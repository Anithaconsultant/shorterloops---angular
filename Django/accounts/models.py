...
class Facility(models.Model):   
    ...
    Facilityname = models.CharField(max_length=60, choices=FACILITY_CHOICES)
    Owner_status = models.CharField(max_length=70, blank=True)
    Owner_id = models.CharField(max_length=70, blank=True)
    Cashbox = models.CharField(max_length=70, blank=True)
...
class Asset(models.Model):      
    ...
    Date_manufactured = models.DateField(default=datetime.date.today,blank=True)
