...
export class MaincityComponent implements AfterViewInit, OnInit {
  ...
  currentUserCartId='';
  positionObject = {
    'House6':  [[ -199, -3525],[712, 3921],[665, 3814],[628, 3726]],
    'House7':  [[ -443, -3538],[1049, 3921],[1003, 3814],[967, 3726]],
    'House8':  [[ -744, -3475],[1384, 3921],[1337, 3814],[1303, 3726]],
    'House9':  [[-1053, -3468],[1718, 3921],[1674, 3814],[1638, 3726]],
    'House10': [[-1282, -3537],[2061, 3921],[2009, 3814],[1978, 3726]],
    'House1':  [[ -199, -3154],[712, 3584],[665, 3459],[628, 3385]],
    ...
    'Recycling truck': [[-5762, -3505],[5930, 3921],[5898, 3814],[6023, 3726]],
    'Supermarket': [[-5762, -3505],[6268, 3921],[6235, 3814],[6361, 3726]],
    'Grocery shop': [[-6158, -3490],[6617, 3921],[6576, 3814],[6698, 3726]],
    'Ubottle': [[-6254, -3485],[6958, 3921],[6910, 3814],[7034, 3726]],
    'Making plant': [[-6564, -3510],[7295, 3921],[7246, 3814],[7371, 3726]],
